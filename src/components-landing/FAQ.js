        ...
        >
          ...
          <AccordionDetails>
            <Typography
              ...
              sx={{ maxWidth: { sm: '100%', md: '70%' } }}
            >
              Durable, resistant to chemicals, easy to clean, and aesthetically pleasing.
            </Typography>
          </AccordionDetails>
        </Accordion>
        <Accordion
        ...
        >
          ...
          <AccordionDetails>
            <Typography
              ...
              sx={{ maxWidth: { sm: '100%', md: '70%' } }}
            >
              Common applications include garages, industrial spaces, commercial buildings, and residential areas.
            </Typography>
          </AccordionDetails>
        </Accordion>
        <Accordion
        ...
        >
          ...
          <AccordionDetails>
            <Typography
              ...
              sx={{ maxWidth: { sm: '100%', md: '70%' } }}
            >
              To fix a crack in your Epoxy floor, it is advised to open the cracked area, after which mix the epoxy solution in the right quantity, that is, 2:1 of resin and hardener, respectively, and pour on the surface; it should be leveled to ensure that it cures properly. Let the material cure for about 60 days.
            </Typography>
          </AccordionDetails>
        </Accordion>
